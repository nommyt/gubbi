...
function fileStatusColor(entry: StatusEntry): string {
  switch (entry.type) {
    case "added":     return C.staged
    case "modified":  return entry.staged ? C.staged : C.modified
    case "deleted":   return C.deleted
    case "renamed":   return C.staged
    case "copied":    return C.staged
    case "untracked": return C.untracked
    case "unmerged":  return C.conflict
                  ...
                  {(entry) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <text fg={isSelected() ? C.selectedText : C.dim}>
                          {entry.path}
                        </text>
                      </box>
                    )
