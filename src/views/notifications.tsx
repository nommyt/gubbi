...
function typeColor(type: string): string {
  switch (type) {
    case "PullRequest": return C.pr
    case "Issue":       return C.issue
    case "Release":     return C.release
...
function reasonLabel(reason: string): string {
  switch (reason) {
    ...
    case "review_requested":  return "review req"
              ...
              {(notif, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Type icon */}
                    <text fg={typeColor(notif.subject.type)}>
                      {typeIcon(notif.subject.type)}
                    </text>

                    {/* Title */}
                    <text fg={notif.unread ? C.unread : C.read}>
                      {notif.subject.title}
                    </text>
